...
def analyse_single_feature(ticker): 
    ...
    test = fa_df.columns.tolist()
    print(test)
    fa_list = ['revenue', 'operationProfit', 'GrossProfit', 'netProfit', 'InterestExpense', 'SellingExpense', 'GAExpense', 'preTax', 'ebitOnInterest', 'netPayableOnEquity', 'shortOnLongTermPayable', 'payableOnEquity', 'payable', 'asset', 'liability', 'equity', 'STDebt', 'LTDebt', 'capitalize', 'priceToEarning', 'priceToBook', 'roe', 'bookValuePerShare', 'valueBeforeEbitda', 'ageOfReceivable', 'ageOfInventory', 'earningPerShare', 'betaIndex', 'EarningYield', 'depreciation', 'dividend', 'payableOnEbitda'] #creating a list for the FA numerics we want to examine 
    ...
    # ------ TRAINING MODEL 
    features_list = ['revenue', 'operationProfit', 'GrossProfit', 'netProfit', 'InterestExpense', 'SellingExpense', 'GAExpense', 'preTax', 'ebitOnInterest', 'netPayableOnEquity', 'shortOnLongTermPayable', 'payableOnEquity', 'payable', 'asset', 'liability', 'equity', 'STDebt', 'LTDebt', 'capitalize', 'priceToEarning', 'priceToBook', 'roe', 'bookValuePerShare', 'valueBeforeEbitda', 'ageOfReceivable', 'ageOfInventory', 'earningPerShare', 'betaIndex', 'EarningYield', 'depreciation', 'payableOnEbitda'] #because we are training single feature models, create features list 
...
'''ticker_list = [user_ticker] #create list with tickers to examine 
